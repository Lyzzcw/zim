...
public final class ExtensionLoader<T> {
    ...
    private static final String RPC_DIRECTORY = "META-INF/lzy/";
    private static final String RPC_DIRECTORY_EXTERNAL = "META-INF/lzy/external/";
    private static final String RPC_DIRECTORY_INTERNAL = "META-INF/lzy/internal/";
